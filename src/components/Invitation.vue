      ...
      <div class="invitation-cover">
        <div class="cover-content" :class="{'invitation-up':isOpening}">
          <div class="content-inside">
            <img class="content-inside-photo" src="../assets/photo.jpg">
            <p>我们结婚啦！</p>
            <p><b>袁峰 & 陆杨柳</b></p>
            <p><i class="iconfont icon-shijian-copy"></i> <b>2021年05月01日</b></p>
            
            <p><i class="iconfont icon-zb-copy"></i> <b>泰兴祥福居大酒店</b></p>
            
            <img class="content-inside-map" src="../assets/map.png" alt="" @click="openLocation">
        ...
        <img class="cover-inside-seal" src="../assets/seal.png" @click="openInvitation" :class="{'invitation-flight':isOpening}">
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    openLocation () {
      location.href = 'https://uri.amap.com/marker?position=120.291456,32.163407&name=祥福居大酒店&coordinate=gaode&callnative=1'
    },
    // 发送弹幕
    sendBarrage(){
      this.$nextTick(() => {
